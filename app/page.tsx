...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-red-50">
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Join the future of literature with BookCryto - where authentic
            novels meet blockchain rewards, interactive games, and a vibrant
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-2 hover:border-green-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Access verified novels from Project Gutenberg and Open Library
            ...
            <Card className="border-2 hover:border-green-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Earn tokens through reading engagement with transparent,
                  immutable smart contract distribution
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-green-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Engage with literature through quizzes, prediction games, and
            ...
            <Card className="border-2 hover:border-green-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Connect with fellow readers through blogs, reviews, and
            ...
            <Card className="border-2 hover:border-green-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Purchase physical and digital books with traditional and
            ...
            <Card className="border-2 hover:border-green-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Discover reading trends and popular titles through real-time
                  insights and visual data charts
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Create your account and connect your blockchain wallet to start
                earning tokens
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Explore our vast library, read novels, participate in games, and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Earn tokens for your activities and use them in our marketplace
                or trade them
              </p>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <motion.section
        className="py-20 px-4 bg-green-600 text-white"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of readers who are already earning tokens and
